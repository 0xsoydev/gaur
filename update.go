...
func (m *model) handleConfirmationKey(msg tea.KeyMsg) (tea.Model, tea.Cmd) {
	...
	case "y", "Y", "enter":
		...
		case confirmCleanKeep3: return m, executePaccacheInTerminal(confirmCleanKeep3, "-r", "-c", m.dashboard.PacmanCachePath, "-c", m.dashboard.ParuCachePath)
		case confirmCleanKeep1: return m, executePaccacheInTerminal(confirmCleanKeep1, "-rk1", "-c", m.dashboard.PacmanCachePath, "-c", m.dashboard.ParuCachePath)
		case confirmCleanUninstalled: return m, executePaccacheInTerminal(confirmCleanUninstalled, "-ruk0", "-c", m.dashboard.PacmanCachePath, "-c", m.dashboard.ParuCachePath)
		case confirmCleanNuke: return m, executePaccacheInTerminal(confirmCleanNuke, "-rk0", "-c", m.dashboard.PacmanCachePath, "-c", m.dashboard.ParuCachePath)
